...
function MainPage() {
  ...
  const [mapcagırma, setmapcagırma] = useState([]);
  let adres = "api/Tedes/GetTedesInformation"
  ...
  const getProducts = async () => {
    ...
    console.log(result.waitingRecords)
    setProducts(result);
  ...
  //     <h2>{Products.waitingRecords}</h2>
  //     {/* {Products.map((item, index) => {
  //     <h2>{item.waitingRecords}</h2>
        ...
        <nav className="navbar-default navbar-static-side" role="navigation">
          <div className="sidebar-collapse">
            <ul className="nav metismenu" id="side-menu">
              ...
              <li className="active">
                <a href="dashboard_6.html"><i className="fa fa-th-large" /> <span className="nav-label">Dashboards</span> <span className="fa arrow" /></a>
                <ul className="nav nav-second-level">
                  ...
                  <li className="active"><a href="dashboard_6.html">Dashboard v.6 </a></li>
                </ul>
              </li>
              <li>
        ...
        <div className="row border-bottom">
          <nav className="navbar navbar-static-top" role="navigation" style={{ marginBottom: 0 }}>
            ...
            <ul className="nav navbar-top-links navbar-right">
              <li>
                <span className="m-r-sm text-muted welcome-message">Welcome to INSPINIA+ tedesservice.</span>
              </li>
          ...
          <div className="row" >
              ...
              <div>
                <div className="col-sm-2">
                  ...
                  <div className="ibox float-e-margins">
                    <div className="ibox-title">
                      <span className="label label-success pull-right">Waiting</span>
                      <h5></h5>
                    </div>
                    <div className="ibox-content">
                      <h1 className="no-margins">{Products.waitingRecords}</h1>

                      
                      <small>Waiting Records</small>
                    </div>
                  </div>
                </div>   
                <div className="col-sm-2">
                  <div className="ibox float-e-margins">
                    <div className="ibox-title">
                      <span className="label label-info pull-right">NoImage</span>
                      <h5></h5>
                    </div>
                    <div className="ibox-content">
                      <h1 className="no-margins">{Products.noImageRecords}</h1>
                     
                      <small>NoImage Records</small>
                    </div>
                  </div>
                </div>
                <div className="col-sm-3">
                  <div className="ibox float-e-margins">
                    <div className="ibox-title">
                      <span className="label label-primary pull-right">DiffrentVehicleClass</span>
                      <h5></h5>
                    </div>
                    <div className="ibox-content">
                      <h1 className="no-margins">{Products.diffrentVehicleClassRecords}</h1>
                      
                      <small>Diffrent Vehicle Class Records</small>
                    </div>
                  </div>
                </div>
                <div className="col-sm-2">
                  <div className="ibox float-e-margins">
                    <div className="ibox-title">
                      <span className="label label-primary pull-right">Sent</span>
                      <h5></h5>
                    </div>
                    <div className="ibox-content">
                      <h1 className="no-margins">{Products.sentRecords}</h1>
                ...
                <div className="col-sm-3">
                  <div className="ibox float-e-margins">
                    <div className="ibox-title">
                      <span className="label label-danger pull-right">Undeliverable</span>
                      <h5></h5>
                    </div>
                    <div className="ibox-content">
                      <h1 className="no-margins">{Products.undeliverableRecords}</h1>
                      <small>Undeliverable Records </small>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="row">
              <div className="col-lg-6">
                <div className="ibox float-e-margins">
                  ...
                  <div className="ibox-content" style={{ position: 'relative' }}>
